...
from third_party.CenterNet2.detectron2.layers import cat
from third_party.CenterNet2.detectron2.modeling import PROPOSAL_GENERATOR_REGISTRY
from third_party.CenterNet2.detectron2.structures import Instances, Boxes
from third_party.CenterNet2.detectron2.utils.comm import get_world_size
from third_party.CenterNet2.projects.CenterNet2.centernet.modeling.debug import debug_train, debug_test
from third_party.CenterNet2.projects.CenterNet2.centernet.modeling.layers.heatmap_focal_loss import \
    heatmap_focal_loss_jit, binary_heatmap_focal_loss
from third_party.CenterNet2.projects.CenterNet2.centernet.modeling.layers.ml_nms import ml_nms
from .utils import reduce_sum, _transpose
from .centernet_head import Proposal_Head
    ...
    def __init__(self, 
        ...
        *,
        ...
        if centernet_head is None:
            self.centernet_head = Proposal_Head(
