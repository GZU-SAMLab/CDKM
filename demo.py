...
from third_party.CenterNet2.detectron2.data.detection_utils import read_image
...
# from cdkm.config import add_grit_config

from cdkm.predictor import VisualizationDemo
